...
"""
spec_analysis.py: This python module contains the CaIIH, HeI, NaI, pEW(Hα), Hα and CaI activity index calculation functions
along with other minor functions called by these index functions.
